/**
 * 
 Project Name : Sound Token Protocol
 
 🌐 WEBSITE: https://soundtoken.org/    
 
 🗨 TELEGRAM: t.me/SoundTokenProtocol
 
 
Max Cap 1,000,000,000 Tokens ; 4000,000 tokens trading limit per transaction
...
contract soundtokenProtocol is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // Burn address
    address public constant TEAM_ADDRESS =
        0xe0665738AeEAd8a89412b4a8993C7fEbECA810cd;
    ...
    string private _name = "SoundTokenProtocol";
    ...
    uint256 public _maxTxAmount = 400 * 10**3 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 40 * 10**3 * 10**18;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "STP::transfer: Mkt value invalid"
            );

            //transfer amount, it will take tax, burn, liquidity fee
            _tokenTransfer(from, TEAM_ADDRESS, mktAmount, false);
